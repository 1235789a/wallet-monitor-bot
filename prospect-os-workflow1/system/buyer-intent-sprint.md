...
The first 14-day validation target is at least 350 source-first raw records, 30 reviewed P0
candidates, 15 completed buyer-query audits, 8 sales conversations and 3 paid sprints. A shortfall
must be diagnosed at the failed funnel stage; it must not automatically trigger more scraping.

## Fixed 50:50 prospect mix
...
4. Five to ten manually reviewed, service-relevant, non-brand buyer queries.
5. At least five tested query result samples with platform/date/scope, returned URLs, prospect
   presence and named competitors.
